...
Review.create!(user_id: 5, username: "jack", book_id: 24, title: "On the Edge", body: "... a mind needs books as a sword needs a whetstone, if it is to keep its edge.")
...
Review.create!(user_id: 5, username: "jack", book_id: 26, title: "Great book!", body: "It is our choices, Harry, that show what we truly are, far more than our abilities.")
